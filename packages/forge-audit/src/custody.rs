...
pub struct CustodyEntry {
    pub id: Uuid, pub session_id: Uuid, pub user: String,
    pub action: CustodyAction, pub timestamp: chrono::DateTime<Utc>,
}

#[derive(Debug, Clone, Serialize, Deserialize)]
pub enum CustodyAction { Viewed, Exported(String), Modified, Accessed }
...
impl ChainOfCustody {
    ...
    pub fn all(&self) -> &[CustodyEntry] { &self.entries }
}
