...
impl Preset {
    ...
    pub fn strategies(&self) -> Vec<&'static str> {
        match self {
            ...
            Preset::LangChain => vec![
                "nudge", "compact", "pause", "escalate", "replace", "rollback",
            ],
