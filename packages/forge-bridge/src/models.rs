        ...
        Self {
            models: vec![
                ModelEntry {
                    ...
                    max_output: 32000,
                    capabilities: vec!["reasoning".into(), "code".into(), "tools".into()],
                },
                ModelEntry {
                ...
                ModelEntry {
                    ...
                    context_window: 200000,
                    max_output: 32000,
                    capabilities: vec!["fast".into(), "tools".into()],
                },
                ModelEntry {
                    id: "gpt-4o".into(),
                    ...
                    max_output: 16384,
                    capabilities: vec!["reasoning".into(), "code".into(), "vision".into()],
                },
                ModelEntry {
                    ...
                    max_output: 32000,
                    capabilities: vec!["fast".into(), "multimodal".into()],
                },
            ],
        }
    }
