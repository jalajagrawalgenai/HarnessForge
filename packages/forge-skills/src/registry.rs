...
impl SkillRegistry {
    ...
    pub fn builtin() -> Self {
        ...
        registry.register(Skill {
            ...
            version: "1.0.0".into(),
            description: "Maximum security posture".into(),
            author: "forgelabs".into(),
            tags: vec!["security".into(), "production".into()],
            preset: Some("solo".into()),
        ...
        registry.register(Skill {
            name: "cost-optimizer".into(),
            version: "1.0.0".into(),
            description: "Minimum cost configuration".into(),
            author: "forgelabs".into(),
            tags: vec!["cost".into(), "dev".into()],
            preset: Some("solo".into()),
        ...
        registry.register(Skill {
            name: "accuracy-max".into(),
            version: "1.0.0".into(),
            description: "Maximum accuracy with adversarial verification".into(),
            author: "forgelabs".into(),
